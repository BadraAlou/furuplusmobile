...
class MyTheme {
  ...
  // static Color _primaryColor = HexColor('#011D8D');
  static Color myPrimaryColor = const Color(0xff011D8D);



  // static Color myGreenColor = HexColor('#026808');
  // static Color myYellowColor = HexColor('#e4c102');
  // static Color myRedColor = HexColor('#d30d09');
